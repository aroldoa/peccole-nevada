...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    	...
    	wp_register_script('jquery', get_template_directory_uri() . '/js/jquery.js', array('jquery'), '1.0.0'); // Custom scripts
        ...
        wp_register_script('bootstrap', get_template_directory_uri() . '/js/lib/bootstrap.min.js', array(), '1.0.0'); // Modernizr
...
if (function_exists('register_sidebar'))
{
  ...
  // Define Sidebar Widget Area 6
    register_sidebar(array(
        'name' => __('Widget Area 6', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'widget-area-6',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
// Define Sidebar Widget Area 7
    register_sidebar(array(
        'name' => __('Widget Area 7', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'widget-area-7',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
// Define Sidebar Widget Area 8
    register_sidebar(array(
        'name' => __('Widget Area 8', 'html5blank'),
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'widget-area-8',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
add_action('init', 'create_post_type_testimonials'); // Add Testimonial Post Type
add_action('init', 'create_post_type_locations'); // Add Testimonial Post Type
//add_action('init', 'create_post_type_services'); // Add Services Post Type
...
/* ----------------------------------- *\
	Enable Custom Row Style for Page Builder
\* ----------------------------------- */
