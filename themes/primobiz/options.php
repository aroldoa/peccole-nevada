...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Website Title', 'options_check'),
		'desc' => __('List your website title here.', 'options_check'),
		'id' => 'site_title',
		'std' => '',
		'type' => 'text');

	$options[] = array(
		'name' => __('Website Description', 'options_check'),
		'desc' => __('Place your website description here.', 'options_check'),
		'id' => 'site_description',
		'std' => '',
		'type' => 'textarea');
	...
	$options[] = array(
		...
		'desc' => __('Upload your website Logo here.', 'options_check'),
		'id' => 'main_logo',
		'type' => 'upload');

	$options[] = array(
		'name' => __('Site Favicon', 'options_check'),
		'desc' => __('Upload your website Favicon here.', 'options_check'),
		'id' => 'favicon',
		'type' => 'upload');

	$options[] = array(
		'name' => __('Copyright', 'options_check'),
		'desc' => __('Edit the site copyright information here.', 'options_check'),
		'id' => 'copyright',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Copy and Past your google api code here.', 'options_check'),
		'id' => 'site_analytics',
		'std' => '',
		'type' => 'textarea');

	$options[] = array(
		'name' => __('Style Settings', 'options_check'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Background Color', 'options_check'),
		'desc' => __('Choose your main background color.', 'options_check'),
		'id' => 'background_color',
		'std' => '#ffffff',
		'type' => 'color' );
	...
	$options[] = array(
		'name' => __('Font Settings', 'options_check'),
		'type' => 'heading' );
	...
	$options[] = array(
		...
		'desc' => __('Paste the URL to your Facebook site here', 'options_check'),
		'id' => 'facebook_link',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Paste the URL to your Twitter site here', 'options_check'),
		'id' => 'twitter_link',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Paste the URL to your Google Plus site here', 'options_check'),
		'id' => 'google_link',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Paste the URL to your Youtube site here', 'options_check'),
		'id' => 'youtube_link',
		'std' => '',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Paste the URL to your Linkedin site here', 'options_check'),
		'id' => 'linkedin_link',
		'std' => '',
		'type' => 'text');
